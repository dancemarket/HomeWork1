...
<!-- page tap icon -->
<link rel="icon" href="${pageContext.request.contextPath}/resources/img/misterland_logo.ico">

<!-- font -->
<link href='http://fonts.googleapis.com/css?family=Montserrat:400,700|Open+Sans:400italic,700italic,400,700' rel='stylesheet' type='text/css'>

<!-- css -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/layers.min.css" media="screen">
